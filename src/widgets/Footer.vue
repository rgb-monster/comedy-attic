<script setup>
    ...
    let socialURLs = {
        facebook: "https://www.facebook.com/EdinburghComedyAttic/",
        twitter: "https://twitter.com/AtticComedy",
        instagram: "https://www.instagram.com/atticcomedy/",
    };
</script>
        ...
        <main>
            <div class="socials">
                <a
                    ...
                    target="_blank"
                    v-for="social in ['instagram', 'facebook', 'twitter']"
                    :key="social"
                >
            ...
            <div class="copy">
                <div>&copy; {{ year }} The Comedy Attic</div>
            </div>
        </main>
    </footer>
</template>
